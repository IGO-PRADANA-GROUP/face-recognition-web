    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                String baru = Application.StartupPath + "/daftarwajah/";
                 baru = baru.Replace("data_absensi", "data_absensi2");
                string sourcePath = @"" + Application.StartupPath + "/daftarwajah/";
                string targetPath = @"" + baru;
